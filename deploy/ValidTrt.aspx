<%@ Page Language="vb" AutoEventWireup="false" EnableViewState="true" CodeBehind="ValidTrt.aspx.vb" Inherits="RGPD.ValidTrt" MasterPageFile="~/trtCrea.Master"%>
        ...
        <tr>
            <td id="menuTD" style="position:fixed;vertical-align: top;">
                <ul>
                    ...
                    <li>
                        <asp:Button ID="btValider" CssClass="bouton" Width="100%" runat="server" Text="Valide" OnClick="btValider_Click" />
                    </li>
                </ul>
                <hr />
                <ul>
            ...
            <td id="bodyTD">
                ...
                <table style="width:100%;">
                    ...
                    <div style="padding-left:5%;">
                        ...
                        <asp:TextBox ID="tbGesSousTrai" runat="server" TextMode="MultiLine" Width="90%" Height="200px"></asp:TextBox><br /><br />
                    </div>
