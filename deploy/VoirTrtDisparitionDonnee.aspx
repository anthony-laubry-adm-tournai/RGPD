<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VoirTrtDisparitionDonnee.aspx.vb" Inherits="RGPD.VoirTrtDisparitionDonnee" MasterPageFile="~/trtCrea.Master" %>
        ...
        <tr>
            <td id="menuTD" style="position:fixed;vertical-align: top;">
                <ul>
                    ...
                    <%
                        If Traitement.IsValid Then
                        %>
                        <li>
                            <asp:Button ID="btModif" CssClass="bouton" runat="server" Text="Modifier" OnClick="btModif_Click" /></li>
                    <%
                        end if
                        %>
                </ul>
