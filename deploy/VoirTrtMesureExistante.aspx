<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VoirTrtMesureExistante.aspx.vb" Inherits="RGPD.VoirTrtMesureExistante" MasterPageFile="~/trtCrea.Master" %>
            ...
            <td id="menuTD" style="position:fixed;vertical-align: top;">
                <ul>
                    ...
                    <%
                        ...
                        %>
                        <li>
                            <asp:Button ID="btModif" CssClass="bouton" Width="100%" runat="server" Text="Modifier" OnClick="btModif_Click" /></li>
                    <%
                        end if
                        %>
                </ul>
