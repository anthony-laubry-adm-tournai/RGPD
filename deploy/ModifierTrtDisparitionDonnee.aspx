<%@ Page Language="vb" AutoEventWireup="false" EnableSessionState="True" CodeBehind="ModifierTrtDisparitionDonnee.aspx.vb" Inherits="RGPD.ModifierTrtDisparitionDonnee" MasterPageFile="~/trtCrea.Master" %>
        ...
        <tr>
            <td id="menuTD" style="position:fixed;vertical-align: top;">
                <ul>
                    ...
                    <li>
                        <hr />
                        <asp:Button ID="btAnnuler" CssClass="bouton" Width="100%" runat="server" Text="Retour" OnClick="btAnnuler_Click" />
                    </li>
                    <li><asp:Button ID="btValider" CssClass="bouton" Width="100%" runat="server" Text="Terminer" OnClick="btValider_Click" /></li>
                </ul>
                <hr />
                <ul>
             ...
             <td id="bodyTD" style="vertical-align: top;">
                 <div style="border: 1px solid grey; text-align: center; margin-top: 1%; margin-bottom: 10px; padding-top: 10px; padding-bottom: 10px;">
                    <span style="color: #FD4664; font-weight: bold;">Risques</span><br />
                            <span style="font-size: 11px;">Cette section vous permet d'apprécier les risques sur la vie privée,
                                <br />
                                compte tenu des mesures existantes ou prévues.</span><br />
                            <span style="color: #FD4664;">DISPARITION DE DONNÉES</span><br />
                            <span style="font-size: 11px;">Analysez les causes et conséquences d'une disparition de données,  
                                <br />
                                et estimez sa gravité et sa vraisemblance.</span>
                </div>
                 ...
                 <div style="padding-left: 5%; padding-top: 10px;">
                     <asp:Repeater ID="rMenace" runat="server" OnItemDataBound="rMenace_ItemDataBound">
                     <ItemTemplate>
                 ...
                 <br />
                 <div style="padding-left: 5%; padding-top: 10px;">
                     <asp:Repeater ID="rSource" runat="server" OnItemDataBound="rSource_ItemDataBound">
                     <ItemTemplate>
                ...
                <br />
                 <div style="padding-left: 5%; padding-top: 10px;">
                     <asp:Repeater ID="rMesure" runat="server" OnItemDataBound="rMesure_ItemDataBound">
                     <ItemTemplate>
