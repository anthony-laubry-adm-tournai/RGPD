<%@ Page Language="vb" AutoEventWireup="false" EnableViewState="true" CodeBehind="ModifierTrtMesureExistante.aspx.vb" Inherits="RGPD.ModifierTrtMesureExistante" MasterPageFile="~/trtCrea.Master" %>
                ...
                <asp:Repeater ID="rMesure" runat="server" OnItemCreated="rMesure_ItemCreated">
                    <ItemTemplate>
                        <div style='border:1px solid grey;padding:25px 25px 25px 25px;'>
                            <asp:TextBox ID="lbTitre" Style="border:1px solid grey;padding-right:15px;" runat="server" Width="500px"></asp:TextBox>
                            <asp:Button ID="btSupA" CssClass="linkButton_button" runat="server" ForeColor="Red" Font-Size="11" Text="Supprimer" /><br />
                            <asp:Label ID="lbDescr" runat="server" ForeColor="#3EE095" Text="Description"></asp:Label><br />
                            <asp:TextBox ID="tbDescr" runat="server" TextMode="MultiLine" width="100%" Height="300"></asp:TextBox><br />
