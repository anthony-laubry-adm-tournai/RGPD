<%@ Page Language="vb" AutoEventWireup="false" EnableViewState="true" CodeBehind="CreerTraitement.aspx.vb" Inherits="RGPD.CreerTraitement" MasterPageFile="~/trtCrea.Master" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td id="menuTD" style="position:fixed;vertical-align: top;">
                <ul >
                    <li>
                        <asp:TextBox ID="tbNomTrt" CssClass="nomTrt" runat="server" AutoPostBack="true" OnTextChanged="tbNomTrt_TextChanged"></asp:TextBox>
                        <hr />
                        <br/>
                    </li>
                    <li>
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td style="padding-bottom: 40px; padding-top: 10px">
                            <asp:RadioButton ID="rbOui" class="choixradio" runat="server" Text="Oui" GroupName="ouinon" /><asp:RadioButton ID="rbNon" class="choixradio" runat="server" Text="Non" GroupName="ouinon" /></td>
                    </tr>
                    ...
                    <div style="padding-left:5%;">
                        ...
                        <asp:TextBox ID="tbGestSousTrai" CssClass="arrondi" runat="server" TextMode="MultiLine" Width="90%" Height="200px"></asp:TextBox><br /><br />
                    </div>    

                    <div style="padding-left:5%;">
                        <asp:Label ID="lbCommentaire" runat="server" Text="Expliquez en quoi chaque donnée collectée est nécessaire (principe de proportionnalité)" Font-Bold="true"></asp:Label><br />
